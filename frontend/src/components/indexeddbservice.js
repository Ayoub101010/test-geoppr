...
class IndexedDBService {
  ...
  async init() {
    ...
    this.initPromise = new Promise((resolve, reject) => {
      ...
      request.onsuccess = () => {
        ...
        console.log('IndexedDB ouvert avec succes');
        resolve(this.db);
      };
  ...
  async save(storeName, key, data) {
    try {
      ...
      console.error('Erreur save IndexedDB:', error);
      return false;
    }
  }
  ...
  async get(storeName, key) {
    try {
      ...
      console.error('Erreur get IndexedDB:', error);
      return null;
    }
  }
  ...
  async clear() {
    try {
      ...
      console.log('IndexedDB vide');
      return true;
    } catch (error) {
      console.error('Erreur clear IndexedDB:', error);
      return false;
    }
  }
}
